...
<head>
    ...
    <meta name="description" content="Ekstrakurikuler">
    <!-- open graph-->
    ...
    <meta name="twitter:description" content="Ekstrakurikuler">

    <link rel="stylesheet" type="text/css" href="http://ditpsd.kemdikbud.go.id/css/bootstrap.min.css">
    <style>
        .clock {
        position: absolute;
        top: 68px;
    ...
    <link rel="stylesheet" type="text/css" href="http://ditpsd.kemdikbud.go.id/css/fontawesome-all.min.css">
		
    <link rel="stylesheet" href="http://ditpsd.kemdikbud.go.id/css/animate.min.css">

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-K6FQK8VXYS"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-SE98BVB2NK');
</script>
...
<br> <br> <br> <br>
    <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v8.0" nonce="Z9BcMYB5"></script>
<div id="preloader">
    <div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
</div>
<div id="top-bar" class="white-color d-none d-sm-block
">
</div>
</div>
...
<!--Breadcrumb END-->
<div class='text-center'><img src='http://ditpsd.kemdikbud.go.id/upload/1601601725-guru_siswa-min.jpg' class='img-fluid'></div>
<!--<div class="breadcrumb-section jarallax pixels-bg" data-jarallax="" data-speed="0.6" style="z-index: 0; background-image: none; background-color: #fff;"> <div id="jarallax-container-0" style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none; z-index: -100; background-color: #fff;"><div style="background-position: 50% 50%; background-size: auto; background-repeat: no-repeat; background-image: url(&quot;http://ditpsd.kemdikbud.go.id/upload/1601601725-guru_siswa-min.jpg&quot;); position: absolute; top: 25px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none; margin-top: 86.7px; transform: translate3d(0px, -127.1px, 0px); background-color: #fff;"></div></div></div>--><!-- section start -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12 col-12">
                <div class="blog-list">
                    <h3 class="mt-3">Ekstrakurikuler</h3>

                    <div class="mt-25 article-body">
                        <p><img alt="" src="http://ditpsd.kemdikbud.go.id/upload/filemanager/2020/10/sda.jpg" style="float:left; height:819px; width:555px" /></p>

<p>Kegiatan ekstrakurikuler sebagai wadah pengembangan potensi peserta didik, dapat memberikan dampak positif dalam penguatan pendidikan karakter. Peserta didik diharapkan dapat mengembangkan karakter profil Pelajar Pancasila yaitu : (1) berkebinekaan global, (2) bergotong royong, (3) kreatif, (4) bernalar kritis, (5) mandiri, dan (6) beriman, bertakwa kepada Tuhan YME, dan berakhlak mulia.</p>
...
<p>Merujuk pada Peraturan Menteri Pendidikan dan Kebudayaan Republik Indonesia Nomor 62 tahun 2014 tentang Kegiatan Ekstrakurikuler Pada Pendidikan Dasar dan Pendidikan Menengah, ekstrakurikuler adalah kegiatan pengembangan karakter dalam rangka perluasan potensi, bakat, minat, kemampuan, kepribadian, kerja sama, dan kemandirian peserta didik secara optimal yang dilakukan di luar jam belajar kegiatan intrakurikuler dan kegiatan kokurikuler di bawah bimbingan dan pengawasan satuan pendidikan.</p>
...
<script src="http://ditpsd.kemdikbud.go.id/js/jquery.min.js"></script>
<script src="assets/js/jam.js"></script>
<script src="assets/js/script.js"></script>
<script src="http://ditpsd.kemdikbud.go.id/js/plugins.js"></script>
<script src="http://ditpsd.kemdikbud.go.id/js/navigation.js"></script>
<script src="http://ditpsd.kemdikbud.go.id/js/navigation.fixed.js"></script>
<script src="http://ditpsd.kemdikbud.go.id/js/main.js"></script>
